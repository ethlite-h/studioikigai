...
const kids = [
  {
    ...
    answers: {
      ...
      k19: { Lobby: { reaction: "Like a hotel? That's boring.", face: "flat, shrug" }, "Co-op": { reaction: "Like Minecraft co-op! Cool.", face: "eyebrows up, small grin" }, suggestion: "TubeBuddy" },
      k20: "No ads.",
    },
  },
  {
