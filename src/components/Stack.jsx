...
const Chip = () => (
  <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 3h2v3h6V3h2v3h1a2 2 0 0 1 2 2v1h3v2h-3v2h3v2h-3v1a2 2 0 0 1-2 2h-1v3h-2v-3H9v3H7v-3H6a2 2 0 0 1-2-2v-1H1v-2h3v-2H1V9h3V8a2 2 0 0 1 2-2h1V3zm2 6v6h6V9H9z"/></svg>
);
  ...
  return (
    <section className="section tight lower" aria-label="Technology" style={{ borderTop: "1px solid var(--line)" }}>
      <div className="wrap stack" style={{ "--gap": "28px" }}>
        <Reveal><p className="mono" style={{ textAlign: "center" }}>Runs on your phone, not our servers</p></Reveal>
        <Reveal delay={0.05} className="stack-strip">
          <span className="mark"><Apple /> iPhone</span>
