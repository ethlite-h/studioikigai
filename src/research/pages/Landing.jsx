  ...
  return (
    <div className="wrap research-page landing">
      <header className="landing-head">
        ...
        <p className="lede">Hi! I'm Helen. I have three kids, 7 to 10, and every day people I've never met get to shape what they find funny, cool, and true. That concerns me the same way it probably concerns you. Before I build anything, I want to know whether other parents want what I want. Two short things: a survey for you, and a conversation to have with your kid.</p>
      </header>

      <section className="landing-belief">
        <p className="body">Here's where I'm starting from. Every tool on offer is a fence: YouTube Kids, Screen Time, blocking. Kids this age still care what their parents think, and that's worth more than any fence. And I'm not trying to get YouTube out of anyone's life. If you've tried the fences and watched them fail, you're exactly who I need to hear from.</p>
      </section>
      ...
      <section className="landing-notes">
        ...
        <ul className="body">
          ...
          <li>Your answers go to one private database that only I can read. No analytics, no tracking, no third-party scripts on these pages. Nothing identifying is stored unless you choose to leave an email.</li>
