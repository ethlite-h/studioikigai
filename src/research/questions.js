...
//   names         name test                           answer: { [name]: { reaction: string, face: string } }
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: "k19", n: 19, type: "names", prompt: "Name test. \"If this app was called ___, and your friend saw it on your iPad, what would they say?\"", help: "Try Lobby, then Co-op. Write the exact reaction, including the face.", names: ["Lobby", "Co-op"] },
